...
int tempsEspera1=1500; //Temps d'espera davant dels sensors per tal de desactivar-los
int tempsEspera2=3000; //Temps de visualització dels estats de transició
...
int estatPostaVar[NUMSIMON5]; // Array per realitzar les proves 2, 4 i 5
...
void inicialitzaArrayPostesVarVell(){
...
void prova3() {
  ...
  if (estatPosta1 == 0 && primeraPosta) {
    apagaCASCO();
    enciendeSoloPOSTA1(255,0,255); //MORADO 55-95
    enciendeSoloPOSTA2(0,0,255); //AZUL 5-45
    apagaPOSTA3();
    enciendeSoloPOSTA4(0,0,255); //AZUL 5-45
    enciendeSoloPOSTA5(255,0,255); //MORADO 55-95
  ...
  //INICI SENSOR POSTA1
   if (estatPosta1 == 0 || estatPosta1 == 1 ){
    ...
    if (estatPosta1 == 0 && distancia1 >= 55 && distancia1 <= 95 && (millis() - marcaTemps11) > 600 ){    
       if (DEBUG) {
          Serial.println(F("SENSOR 1: Primera Part -- estatPosta1=0"));          
        }
    ...
    }else if (estatPosta1 == 1 && distancia1 >= 55 && distancia1 <= 95 ) {
      if (DEBUG) {
          Serial.println(F("SENSOR 1: Segona Part -- estatPosta1=1"));          
      }
   ...
   //CODI PER ENCENDRE I JUGAR AMB 5 POSTES   
    if (estatPosta1 == 2) {
      if (estatPosta2 == 0 || estatPosta2 == 1 ){
        ...
        if (estatPosta2 == 0 && distancia2 >= 5 && distancia2 <= 45 && (millis() - marcaTemps21) > 600){
          enciendeSoloPOSTA2(255,255,0); //GROC
          marcaTemps2 = millis();
          estatPosta2=1;
        }else if (estatPosta2 == 1 && distancia2 >= 5 && distancia2 <= 45 ) {
      ...
      if (estatPosta2 == 2) {       
          ...
          if (estatPosta4 == 0 && distancia4 >= 5 && distancia4 <= 45 && (millis() - marcaTemps41) > 600 ){
            enciendeSoloPOSTA4(255,255,0); //GROC
            marcaTemps4 = millis();
            estatPosta4=1;
          }else if (estatPosta4 == 1 && distancia4 >= 5 && distancia4 <= 45 ) {
          ...
          if (estatPosta4 == 2){
            ...
            if (estatPosta5 == 0 && distancia5 >= 55 && distancia5 <= 95 && (millis() - marcaTemps51) > 600 ){
              enciendeSoloPOSTA5(255,255,0); //GROC
              marcaTemps5 = millis();
              estatPosta5=1;
            }else if (estatPosta5 == 1 && distancia5 >= 55 && distancia5 <= 95 ) {
              if ( (millis() - marcaTemps5) > tempsEspera1 ){
                client.publish("sala1/completado","on");
                enciendeSoloPOSTA5(0,255,0); //VERD
                estatPosta5=2;
              ...
              enciendeSoloPOSTA5(255,0,255); //MORAT
              estatPosta5=0;
              marcaTemps51 = millis();
            }
          }//EstatPosta4 == 2         
    ...
    if (estatPosta1 == 2 && estatPosta2 == 2 && estatPosta4 == 2 && estatPosta5 == 2) {
  ...
  if ( index < NUMSIMON4 ) {    
    ...
    //INICI SENSORS
     if (estatPostaVar[index1] == 0 || estatPostaVar[index1] == 1 ){    
      ...
      if (estatPostaVar[index1] == 0 && distancia >= distMin && distancia <= distMax && (millis() - marcaTemps11) > 600 ){    
        if (DEBUG) {
...
void prova5a(){
   ...
   if (estatPosta1 == 0 && distancia1 >= 55 && distancia1 <= 95 && (millis() - marcaTemps11) > 600 && estatPosta5 == 0 && distancia5 >= 55 && distancia5 <= 95 && (millis() - marcaTemps51) > 600 ){    
       if (DEBUG) {
    ...
    }else if (estatPosta1 == 1 && distancia1 >= 55 && distancia1 <= 95 && estatPosta5 == 1 && distancia5 >= 55 && distancia5 <= 95 ) {
      if (DEBUG) {
...
void transicio5(){
  ...
  enciendeSoloCASCO(0,255,0);
  //delay(tempsEspera2);
  delay(12000); //Temps espera mentre Baixa Pisto i agafen CASCO ALADO
...
void errorReinici(){
  client.publish("sala1/error","on");  //si volem que reinicie el pisto
  enciendeTODAS(255,0,0); 
  delay(tempsEspera2);
  index=0;
  index1=0;
...
void loop() {
 ...
 switch(estat){    
    ...
    case 2:
      ...
      prova2();
      if ( estat == 2 && tempsProva2 > 0 && (millis() - tempsProva2) > 20000) {
        errorReinici();
        tempsProva2=0;
    ...
    case 4:    
      ...
      if (estat == 4 && tempsProva4 > 0 && (millis() - tempsProva4) > 30000) {
        errorReinici();
        tempsProva4=0;
    ...
    case 5:
      ...
      if (tempsProva5 > 0 && !primeraVegada && (millis() - tempsProva5) > 60000) {
        errorReinici();
        tempsProva5=0;
